...
* Understand regional and customer contribution to revenue
...
The Sales & Profit Dashboard focuses on detailed revenue and profitability analysis. This dashboard includes monthly sales and profit trends, top-selling products, most profitable sub-categories, profit target achievement analysis using gauge charts, customer revenue contribution, and loss-making product analysis.

### Category Analysis Dashboard

The Category Analysis Dashboard was created to evaluate category and sub-category performance across the business. It includes revenue contribution by sub-category, quantity sold by category, discount analysis, shipping mode efficiency, and category-wise performance comparison using multiple visualizations.

### Regional Analysis Dashboard

The Regional Analysis Dashboard focuses on geographical business performance. This dashboard analyzes region-wise revenue, state-wise sales performance, top-performing cities, and regional revenue trends over time using comparative visualizations.
...
* The West region showed strong overall business performance.
...
* Reduce excessive discounts on low-margin products to improve profitability.
* Focus marketing efforts on high-performing regions and customer segments.
* Improve profitability in underperforming sub-categories.
